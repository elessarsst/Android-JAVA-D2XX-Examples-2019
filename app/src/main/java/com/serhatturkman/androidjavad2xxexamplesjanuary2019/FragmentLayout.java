            ...
            if (savedInstanceState == null) {
                ...
                if (f == null) {
                    switch (currect_index) {
                        case 0:
                            f = new DeviceInformationFragment();
                            break;
                        case 1:
                            f = new DeviceStatusFragment();
                            break;
                        case 2:
                            f = new DevicePIDVIDFragment();
                            break;
                        case 3:
                            f = new MiscFragment();
                            break;
                        case 4:
                            f = new OpenDeviceFragment();
                            break;
                        case 5:
                            f = new DeviceUARTFragment();
                            break;
                        case 6:
                            f = new DeviceFileTransferFragment();
                            break;
                        case 7:
                            f = new EEPROMFragment();
                            break;
                        case 8:
                            f = new EEPROMUserAreaFragment();
                            break;
                        case 9:
                            f = new FT4232HTestFragment();
                            break;
                        case 10:
                            f = new FT2232HTestFragment();
                            break;
                        case 11:
                            f = new RS232PinConfigFragment();
                            break;
                        case 12:
                            f = new MPSEFragment();
                            break;
                        case 13:
                            f = new FtdiEventFragment();
                            break;
                        default:
